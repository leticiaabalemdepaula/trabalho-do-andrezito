...
const bancoDeFases = {
    1: { titulo: "Fase 1: Floresta Sombria", descricao: "A mata é tão fechada que a luz do sol mal consegue passar.", fundo: "url('floresta.png')", inimigos: [{ nome: "Lobo Selvagem", categoria: "🍃 Fera Natural", hp: 30, maxHp: 30, dano: 5, recompensaOuro: 15, recompensaXp: 15, imagem: "https://images.unsplash.com/photo-1590424753858-3c6d1b400120?auto=format&fit=crop&w=200&q=80" }, { nome: "Goblin Saqueador", categoria: "👺 Goblinóide", hp: 45, maxHp: 45, dano: 8, recompensaOuro: 35, recompensaXp: 28, imagem: "https://images.unsplash.com/photo-1607604276583-eef5d076aa5f?auto=format&fit=crop&w=200&q=80" }], boss: { nome: "Espírito Ancestral", categoria: "🔥 BOSS DA FLORESTA", hp: 1200, maxHp: 1200, dano: 35, recompensaOuro: 1500, recompensaXp: 1600, isBoss: true, imagem: "https://images.unsplash.com/photo-1559103444-2453e1be4bf2?auto=format&fit=crop&w=200&q=80" } },
    2: { titulo: "Fase 2: Cavernas Profundas", descricao: "Um labirinto de pedra úmida. O ar cheira a enxofre.", fundo: "url('labirinto.png')", inimigos: [{ nome: "Morcego Vampiro", categoria: "🦇 Fera", hp: 90, maxHp: 90, dano: 16, recompensaOuro: 60, recompensaXp: 55, imagem: "https://images.unsplash.com/photo-1518930030584-1845184fb2b6?auto=format&fit=crop&w=200&q=80" }, { nome: "Golem", categoria: "💎 Elemental", hp: 130, maxHp: 130, dano: 22, recompensaOuro: 85, recompensaXp: 75, imagem: "https://images.unsplash.com/photo-1509248961158-e54f6934749c?auto=format&fit=crop&w=200&q=80" }], boss: { nome: "Rei Dragão", categoria: "🔥 BOSS DA CAVERNA", hp: 2800, maxHp: 2800, dano: 45, recompensaOuro: 2500, recompensaXp: 300, isBoss: true, imagem: "https://images.unsplash.com/photo-1614023349208-16bd40d5885c?auto=format&fit=crop&w=200&q=80" } },
    3: { titulo: "Fase 3: Castelo em Ruínas", descricao: "O epicentro da corrupção.", fundo: "url('trono.png')", inimigos: [{ nome: "Cavaleiro Caído", categoria: "💀 Morto-Vivo", hp: 180, maxHp: 180, dano: 30, recompensaOuro: 120, recompensaXp: 110, imagem: "https://images.unsplash.com/photo-1520658428289-497793d56f1a?auto=format&fit=crop&w=200&q=80" }, { nome: "Gárgula", categoria: "🦇 Demônio", hp: 220, maxHp: 220, dano: 38, recompensaOuro: 150, recompensaXp: 140, imagem: "https://images.unsplash.com/photo-1620060938637-29d665b1c5e6?auto=format&fit=crop&w=200&q=80" }], boss: { nome: "Lorde das Sombras", categoria: "👑 BOSS FINAL", hp: 6000, maxHp: 6000, dano: 60, recompensaOuro: 3400, recompensaXp: 4500, isBoss: true, imagem: "https://images.unsplash.com/photo-1518331539958-c2b64d0bb037?auto=format&fit=crop&w=200&q=80" } }
};
