...
const bancoDeFases = {
    ...
    3: { titulo: "Fase 3: Castelo em Ruínas", descricao: "O epicentro da corrupção.", fundo: "url('https://images.unsplash.com/photo-1534067783941-51c9c23ecefd?q=80&w=1920&auto=format&fit=crop')", inimigos: [{ nome: "Cavaleiro Caído", categoria: "💀 Morto-Vivo", hp: 180, maxHp: 180, dano: 30, recompensaOuro: 120, recompensaXp: 110, imagem: "https://images.unsplash.com/photo-1520658428289-497793d56f1a?auto=format&fit=crop&w=200&q=80" }, { nome: "Gárgula", categoria: "🦇 Demônio", hp: 220, maxHp: 220, dano: 38, recompensaOuro: 150, recompensaXp: 140, imagem: "https://images.unsplash.com/photo-1620060938637-29d665b1c5e6?auto=format&fit=crop&w=200&q=80" }], boss: { nome: "Lorde das Sombras", categoria: "👑 BOSS FINAL", hp: 600, maxHp: 600, dano: 60, recompensaOuro: 1500, recompensaXp: 1000, isBoss: true, imagem: "https://images.unsplash.com/photo-1518331539958-c2b64d0bb037?auto=format&fit=crop&w=200&q=80" } }
};
